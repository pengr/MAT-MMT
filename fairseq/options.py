...
def add_preprocess_args(parser):  # actual preprocessing parameters
    ...
    # map source and target words appearing less than threshold times to unknown
    ...
    parser.add_argument('--dataset-impl', metavar='FORMAT', default='mmap',
                        ...
                        help='output dataset implementation') # the format of output dataset, 'raw/lazy/cached/mmap'-> different data processing methods
    ...
    # fmt: on
    # <<fix>>
    group.add_argument("--image-suffix", metavar="FP", default=None, help="extra image index file suffix")
    group.add_argument("--label-suffix", metavar="FP", default=None, help="extra label file suffix")
    group.add_argument("--pretrained-cnn", type=str,
    ...
    group.add_argument("--images-path", type=str,
                       help="Path to the directory containing the images",
                       default="/home/icalixto/resources/multi30k/images")
    group.add_argument("--train-fnames", type=str,
