...
# model = pretrainedmodels.__dict__[args.pretrained_cnn](num_classes=1000, pretrained='imagenet')
opts = {
...
tf_img = pretrainedmodels.utils.TransformImage(opts)


def parse_image(path_img):
